...
function setup() {
	...
	dground = new Ground();
	stones = new Stone(10,40,25);
	mango1 = new Mango(700,240,26);
	mango2 = new Mango(855,325,26);
	mango3 = new Mango(670,260,26);
	mango4 = new Mango(730,200,26);
	mango5 = new Mango(710,320,26);
	mango6 = new Mango(780,250,26);
	mango7 = new Mango(825,170,26);
	mango8 = new Mango(880,260,26);
	mango9 = new Mango(940,220,26);
	mango10 = new Mango(980,305,26);
